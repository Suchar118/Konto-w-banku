...
public class KontoPlusTests
{
    ...
    {
        var konto = new KontoPlus("Bogdan Brzozka", 500, 400);
    ...
    {
        var konto = new KontoPlus("Wiesia Ptok", 800, 300);
        konto.BlokujKonto();
    ...
    {
        var konto = new KontoPlus("Bogdan Brzozka", 600, 250);
    ...
    {
        var konto = new KontoPlus("Wiesia Ptok", 0, 300);
        konto.Wplata(200);
    ...
    {
        var konto = new KontoPlus("Bogdan Brzozka", 0, 400);
        konto.Wyplata(200);
        konto.Wplata(80);
    ...
    {
        var konto = new KontoPlus("Wiesia Ptok", 0, 350);
    ...
    {
        var konto = new KontoPlus("Wiesia Ptok", 600, 300);
    ...
    {
        var konto = new KontoPlus("Bogdan Brzozka", 400, 300);
        konto.Wyplata(600);
        Assert.IsTrue(konto.Zablokowane);
    }
    ...
    {
        var konto = new KontoPlus("Wiesia Ptok", 700, 400);
        konto.BlokujKonto();
    ...
    {
        var konto = new KontoPlus("Bogdan Brzozka", 300, 400);
    ...
    {
        var konto = new KontoPlus("Wiesia Ptok", 300, 350);
        konto.Wyplata(600);
        konto.Wplata(200);
